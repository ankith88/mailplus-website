export function PortalQuestionsHero() {
  return (
    <section
    ...
    >
      ...
      <div className="relative z-10 max-w-3xl mx-auto text-center py-24">
        ...
        >
          Commonly Asked{' '}
          <span className="italic" style={{ color: '#EAF044' }}>Portal Questions</span>
        </h1>
        <p className="text-xl leading-relaxed" style={{ color: 'rgba(255,255,255,0.72)' }}>
          Everything you need to know about using the ShipMate shipping portal.
        </p>
      </div>
    </section>
  )

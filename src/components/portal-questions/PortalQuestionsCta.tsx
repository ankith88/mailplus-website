...
export function PortalQuestionsCta() {
  return (
    <section
    ...
    >
      ...
      <div className="relative z-10 max-w-3xl mx-auto text-center">
        ...
        >
          ...
          <span className="italic" style={{ color: '#EAF044' }}>We&apos;re here to help.</span>
        </h2>
        <p
          className="text-lg leading-relaxed mb-10"
          style={{ color: 'rgba(255,255,255,0.72)' }}
        >
          Submit a ShipMate support ticket and our IT Systems and Customer Service
          team will get back to you ASAP.
        </p>

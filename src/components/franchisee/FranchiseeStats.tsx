const stats = [
  { value: '120+', label: 'Franchises Nationwide', sub: 'And growing every year' },
  ...
  { value: '680+', label: 'Business Clients', sub: 'Across Australia' },
]

export function FranchiseeStats() {
  return (
    <section
      className="py-16 px-6"
      style={{ backgroundColor: '#DAE8DA' }}
      aria-label="Franchise statistics"
    >

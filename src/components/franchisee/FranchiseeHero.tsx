  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center">
        ...
        <h1
          id="franchisee-hero-heading"
          className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight"
          style={{ color: '#ffffff', fontFamily: 'var(--font-display)' }}
        >
          Own your own courier business.{' '}
          <span className="italic" style={{ color: '#EAF044' }}>Back yourself with MailPlus.</span>
        </h1>
        ...
        >
          With 120+ franchises across Australia, we&apos;re always looking for new franchisees
          and investors to help us deliver to more customers Australia-wide.
        </p>
        <p
          className="text-lg leading-relaxed mb-10"
          style={{ color: 'rgba(255,255,255,0.55)' }}
        >
          No courier experience needed. Full training, technology, and ongoing support provided.
        </p>

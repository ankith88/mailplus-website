...
export function Shipping101Hero() {
  return (
    <section
    ...
    >
      ...
      <div className="relative z-10 max-w-4xl mx-auto">
        ...
        <nav className="flex items-center gap-2 text-xs mb-8" aria-label="Breadcrumb" style={{ color: 'rgba(255,255,255,0.50)' }}>
          ...
          <span aria-hidden="true">/</span>
          <span style={{ color: '#EAF044' }}>Shipping 101</span>
        </nav>
        ...
        >
          Shipping 101 for{' '}
          <span className="italic" style={{ color: '#EAF044' }}>Small Business</span>
        </h1>
        ...
        >
          Everything you need to know about shipping — from choosing the right packaging
          to getting your parcels delivered express, Australia-wide.
        </p>

        <div className="flex items-center gap-4 text-xs" style={{ color: 'rgba(255,255,255,0.45)' }}>
          <span>Published 7 April 2021</span>
          <span aria-hidden="true">·</span>
          <span>Updated 29 July 2024</span>
          <span aria-hidden="true">·</span>

...
export const metadata: Metadata = {
  title: 'Same-Day Courier Sydney | 2–4 Hour Delivery | MailPlus',
  description: 'MailPlus same-day courier delivers anywhere in Sydney within 2–4 hours. GPS tracking, proof of delivery, insured. Book online or call our Waterloo depot.',
  alternates: { canonical: 'https://mailplus.com.au/services/courier' },
}

export default function CourierPage() {
  const service = getServiceBySlug('courier')
  ...
  const breadcrumbSchema = buildBreadcrumbSchema([
    ...
    { name: 'Same-Day Courier', url: 'https://mailplus.com.au/services/courier' },
  ])
...
function ServicePageContent({ service }: { service: ReturnType<typeof getServiceBySlug> }) {
    ...
    <>
      ...
      <div className="pt-32 pb-20 px-6 bg-earth-950 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            {service.name}
            <span className="italic text-earth-400"> in Sydney</span>
          </h1>
          ...
          <div className="flex flex-wrap gap-4">
            ...
            >
              Book Now — From ${service.startingPrice}
            </Link>
            <a
      ...
      <section className="py-20 px-6 bg-earth-900" aria-labelledby="features-heading">
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <span className="gradient-text italic">Every Booking?</span>
          </h2>
      ...
      {/* FAQ */}
      <section className="py-20 px-6 bg-earth-950" aria-labelledby="faq-heading">
      ...
      <section className="py-16 px-6 bg-earth-900">
        <div className="max-w-3xl mx-auto text-center">
          <h2
            ...
            style={{ fontFamily: 'var(--font-display)' }}
          >
            Ready to Book Your Sydney Courier?
          </h2>
          <p className="text-earth-400 mb-8">
            Pickups available Monday–Saturday. No account required. Instant confirmation.
          </p>
          <Link
            href="/contact"
